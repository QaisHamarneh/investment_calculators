...
_recipes_pil_prescript(['Hdf5StubImagePlugin', 'TgaImagePlugin', 'BmpImagePlugin', 'SunImagePlugin', 'XVThumbImagePlugin', 'PcxImagePlugin', 'Jpeg2KImagePlugin', 'MspImagePlugin', 'IcoImagePlugin', 'FtexImagePlugin', 'GbrImagePlugin', 'EpsImagePlugin', 'FitsStubImagePlugin', 'SpiderImagePlugin', 'MicImagePlugin', 'BufrStubImagePlugin', 'PixarImagePlugin', 'TiffImagePlugin', 'FliImagePlugin', 'FitsImagePlugin', 'XpmImagePlugin', 'IptcImagePlugin', 'PalmImagePlugin', 'CurImagePlugin', 'DcxImagePlugin', 'DdsImagePlugin', 'JpegImagePlugin', 'McIdasImagePlugin', 'ImImagePlugin', 'PdfImagePlugin', 'PsdImagePlugin', 'PpmImagePlugin', 'WmfImagePlugin', 'BlpImagePlugin', 'WebPImagePlugin', 'XbmImagePlugin', 'MpoImagePlugin', 'FpxImagePlugin', 'PcdImagePlugin', 'IcnsImagePlugin', 'PngImagePlugin', 'GribStubImagePlugin', 'GifImagePlugin', 'MpegImagePlugin', 'SgiImagePlugin', 'ImtImagePlugin'])
...
DEFAULT_SCRIPT='Investment Calculators.py'
SCRIPT_MAP={}
_run()
